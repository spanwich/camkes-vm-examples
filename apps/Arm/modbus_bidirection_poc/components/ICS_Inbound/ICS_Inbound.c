...
void pre_init(void) {
    ...
    DEBUG_INFO("ICS_Inbound: v2.240 (2025-11-02) - Stable external→internal validation\n");
    DEBUG_INFO("ICS_Inbound: Features: Metadata logging, EverParse hooks, close_queue forwarding\n");
}
